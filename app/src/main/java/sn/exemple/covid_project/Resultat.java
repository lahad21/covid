...
public class Resultat extends Questionnaire {
    ...
    private FloatingActionButton apel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apel = (FloatingActionButton) findViewById(R.id.btn_call);
    ...
    private void callNow() {
        ...
        callIntent.setData(Uri.parse("tel:" + 772164753));
        try {
            this.startActivity(callIntent);
        } catch (Exception ex) {
            Toast.makeText(getApplicationContext(),"échec de l'appelle... " + ex.getMessage(),
